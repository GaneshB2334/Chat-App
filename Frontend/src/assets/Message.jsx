...
const Message = ({ getFormattedDate, currentChat, msg }) => {
    return (
        <div className={`flex ${currentChat._id !== msg.receiverId ? "justify-start" : "justify-end"} text-black font-sans font-semibold relative`}>
            <div className={`relative bg-blue-600 p-2 rounded-xl min-w-[100px] max-w-[49%] ${currentChat._id !== msg.receiverId ? "rounded-bl-none bg-[#444452] " : "rounded-br-none bg-blue-600 "} `}>
                {msg.message}
