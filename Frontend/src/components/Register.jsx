  ...
  return (
    <div className="flex flex-col min-h-screen w-screen items-center justify-center">
      ...
      <div className="shadow-md p-5 bg-darkest text-litest">
        <h1 className="w-full text-center text-4xl  my-4 font-sans">
          Register
        </h1>
        <form>
          ...
          <div className="text-xl flex flex-col gap-2">
            ...
            <input
              className="text-black p-3 rounded-md w-full outline-none"
              type="text"
              autoFocus
              required
              id="fullname"
          ...
          <div className="text-xl flex flex-col gap-2">
            ...
            <div className="w-full relative">
              ...
              <div className="absolute right-0 top-2 w-[10%]">
                ...
                >
                  {isCnfPasswordVisible ? <RemoveRedEye /> : <VisibilityOff />}
                </IconButton>
              </div>
            </div>
          </div>
