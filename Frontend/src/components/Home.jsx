...
const Home = () => {
    ...
    const socket = useMemo(() => io('https://chat-app-ku8j.onrender.com', {
    ...
    return (
        <>
            ...
            {ConfirmState && <ConfirmBlock setConfirmState={setConfirmState} header="Do you Want to Logout ?" />}
            {isLargeView && <LargeView setIsLargeView={setIsLargeView} profile={profile} />}
            {isProfileOption && <Settings setIsProfileOption={setIsProfileOption} setIsLargeView={setIsLargeView} HandleProfileChange={HandleProfileChange} HandleProfileRemove={HandleProfileRemove} setProfile={setProfile} profile={profile} />}
        </>
    )
}
